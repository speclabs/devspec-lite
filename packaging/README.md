...
- WinGet: a portable `devspec-lite.exe`, its SHA-256 file, and versioned WinGet manifests with the release URL and SHA-256 inserted. The workflow attaches them to the GitHub release; submit the generated manifests to `winget-pkgs` separately.
