...
<workflow command="devspec.diagram">
  ...
  <input>Diagram queue ID, subject, work item, explicit process-flow batch request, or format request in the current repository or an explicitly scoped multi-repository system.</input>
  <rules>
